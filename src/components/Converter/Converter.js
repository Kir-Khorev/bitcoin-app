  ...
  return (
    <div className="converter">
      <InputGroup size="lg" className="converterAmount">
        <Button onClick={() => incAmount()} variant="info">
          +
        </Button>
        <Button onClick={() => decAmount()} variant="info">
          -
        </Button>
        <FormControl
          type="text"
          ...
          placeholder="1"
        />
        <InputGroup.Text id="basic-addon1" className="converterAmount__amount">
          Amount
        </InputGroup.Text>
      </InputGroup>
      ...
      <h1>
        Result:{" "}
        {fromCurrency && toCurrency ? (fromCurrency * amount) / toCurrency : 0}
      </h1>
    </div>
  );
}
